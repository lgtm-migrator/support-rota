module Patterdale
  module OutOfHours
    ...
    class Rotations
      ...
      def initialize(ooh_rotation_ids: ENV.fetch("OPSGENIE_OUT_OF_HOURS_ROTATION_IDS"), first_line_schedule_id: ENV.fetch("OPSGENIE_FIRST_LINE_SCHEDULE_ID"), second_line_schedule_id: ENV.fetch("OPSGENIE_SECOND_LINE_OOH_SCHEDULE_ID"))
