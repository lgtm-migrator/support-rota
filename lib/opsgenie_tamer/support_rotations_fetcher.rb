module OpsgenieTamer
  class SupportRotationsFetcher
    ...
    def initialize(first_line_schedule_id: ENV.fetch("OPSGENIE_FIRST_LINE_SCHEDULE_ID"), second_line_schedule_id: ENV.fetch("OPSGENIE_SECOND_LINE_OOH_SCHEDULE_ID"))
