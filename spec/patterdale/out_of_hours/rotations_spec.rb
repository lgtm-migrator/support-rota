...
RSpec.describe Patterdale::OutOfHours::Rotations do
  ...
  before do
    ...
    stub_support_rotations(date: Date.today, id: ENV.fetch("FIRST_LINE_SCHEDULE_ID"), fixture_name: "first_line_ooh_rotations")
    stub_support_rotations(date: Date.today, id: ENV.fetch("SECOND_LINE_SCHEDULE_ID"), fixture_name: "second_line_ooh_rotations")
  end
